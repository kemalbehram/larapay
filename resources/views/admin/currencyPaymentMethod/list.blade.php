						...
						@if($list_menu == 'paystack')
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input class="form-control" name="paystack[secret_key]" type="text" placeholder="paystack Secret Key"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->secret_key : '' }}" id="paystack_secret_key">

									@if ($errors->has('paystack[secret_key]'))
									<span class="help-block">
										<strong>{{ $errors->first('paystack[secret_key]') }}</strong>
									</span>
									@endif
								</div>
							</div>
